...
CREATE TABLE "pessoas" (
  ...
  CONSTRAINT "pessoas_idUsuario_uk" UNIQUE ("idUsuario"),
...
CREATE TABLE "inscricoes" (
  ...
  "idItemPedido" BIGINT NOT NULL,
  "idEquipe"     BIGINT NULL,
  "status"       VARCHAR(20) NOT NULL,
  "dataCriacao"  TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  "dataAtualiza" TIMESTAMP NULL,
...
CREATE TABLE "tokensRecuperacaoSenha" (
  ...
  "motivoEncerramento" VARCHAR(60) NULL,
...
-- TABELA: controleRecuperacaoSenha
...
-- Seed de cidades
INSERT INTO "cidades" ("codIbge","nome","uf") VALUES
  ...
  (2308005, 'Massapê', 'CE'),
  (2308104, 'Mauriti', 'CE')
ON CONFLICT ("codIbge") DO NOTHING;
